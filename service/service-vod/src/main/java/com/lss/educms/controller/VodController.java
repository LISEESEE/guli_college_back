...
import com.lss.educms.service.VodService;
import com.lss.educms.util.ConstantVodUtils;
import com.lss.educms.util.InitVodCilent;
...
public class VodController {
    ...
    public R getPlayAuth(@PathVariable String id) {
        try {
            ...
            throw new ServiceException(20001,"获取凭证失败");
        }
    }
}